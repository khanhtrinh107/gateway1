...
export const EmployeeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.employeeEmployee.delete.question">
        <Translate contentKey="gatewayApp.employeeEmployee.delete.question" interpolate={{ id: employeeEntity.id }}>
